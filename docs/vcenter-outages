...
At the moment, the upgrader VM is vm-23a84eb3-3c16-4392-a7b8-16f536b5c951, who knows if this updates. If you accidentally pick the wrong VM and it is managed by bosh, vcenter will give you a helpful warning that the VM is managed by the vsphere cpi, you probably shoulnd't be directly starting that VM.
